...
int main() {
    // Testing calls with 5 args
    simple_posts_test5();
    // Testing calls with 4 args
    simple_posts_test4();
    // Testing calls with 3 args
    simple_posts_test3();
    // Testing calls with 2 args
    simple_posts_test2();
    // Testing calls with 1 args
    simple_posts_test1();
    // Testing calls with 0 args
    simple_posts_test0();
    ...
    // Testing call_every
    call_every_test<20>();
    // Testing allocate failure
    allocate_failure_test();

    // Testing event cancel 1
    cancel_test1<20>();
    // Testing the event class
    event_class_test();
    // Testing the event class helpers
    event_class_helper_test();
    // Testing the event inference
    event_inference_test();
